...
export default function LearnSection({ testimonial }: LearnSectionProps) {
  ...
  const description = [
    "• Hands-on venture capital experience through our industry-designed training program",
    "• Access to mentors, workshops, and financial modeling resources beyond the classroom",
    "• Practical skills in financial analysis, market research, and due diligence processes",
    "• Personalized guidance from industry veterans with years of expertise",
  ];
  ...
  return (
    ...
    >
      {/* Background with educational theme */}
      <div className="absolute inset-0">
        <Image
          src="/backgrounds/peterwb.webp"
      ...
      {/* Floating educational icons with consistent positioning */}
          ...
          {[1, 2, 3].map((step) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-500 cursor-pointer hover:scale-110 ${
                step === 1 ? "bg-[#17A2FF]" : "bg-gray-600 hover:bg-gray-500"
              }`}
              title={
                step === 1
                  ? "Learn Section"
