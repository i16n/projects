...
export default function InvestSection({ testimonial }: InvestSectionProps) {
  ...
  const description = [
    "• We are a full-fledged investment firm with real dollars—not a school club or simulation",
    "• Students analyze and vote on actual investment opportunities in exciting tech companies",
    "• Get exclusive access to operations of top companies when everyone is trying to get a peek",
    "• Work alongside industry-leading venture capital firms on deals with real impact",
  ];
  ...
  return (
    ...
    >
      {/* Background with investment theme */}
      <div className="absolute inset-0">
        <Image
          src="/backgrounds/talking.webp"
          alt="Investment Environment"
          fill
      ...
      {/* Animated money/investment icons */}
          ...
          {[1, 2, 3].map((step) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-500 cursor-pointer hover:scale-110 ${
                step === 2 ? "bg-[#17A2FF]" : "bg-gray-600 hover:bg-gray-500"
              }`}
              title={
                step === 1
                  ? "Learn Section"
